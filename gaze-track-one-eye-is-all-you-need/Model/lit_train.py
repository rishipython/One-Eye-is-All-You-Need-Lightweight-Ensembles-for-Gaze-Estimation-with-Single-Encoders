...
parser.add_argument('--save_dir', default='../model/google_cnn_SOUP_1/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-cnn-SOUP-1', help='Path store checkpoints')

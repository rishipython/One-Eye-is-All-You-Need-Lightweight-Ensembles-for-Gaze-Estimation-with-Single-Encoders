...
from lit_mobilenet import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_mobilenet/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-mobilenet', help='Path store checkpoints')

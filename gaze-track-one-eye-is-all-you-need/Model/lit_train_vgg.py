...
from lit_vgg import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_vgg/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-vgg', help='Path store checkpoints')

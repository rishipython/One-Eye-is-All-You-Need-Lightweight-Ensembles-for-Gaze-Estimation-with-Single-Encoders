...
from lit_tiny_inception_soup import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_tiny_inception_SOUP/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-tiny-inception-SOUP', help='Path store checkpoints')

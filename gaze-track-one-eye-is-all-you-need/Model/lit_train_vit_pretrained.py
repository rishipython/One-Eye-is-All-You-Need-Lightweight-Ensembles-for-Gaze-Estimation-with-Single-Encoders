...
from lit_vit_pretrained import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_vit_pretrained/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-vit-pretrained', help='Path store checkpoints')

...
from lit_cct import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_cct/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-cct', help='Path store checkpoints')

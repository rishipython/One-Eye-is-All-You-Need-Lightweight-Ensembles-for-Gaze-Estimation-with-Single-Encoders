...
from lit_efficientnet_pretrained import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_efficientnet_pretrained/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-efficientnet-pretrained', help='Path store checkpoints')

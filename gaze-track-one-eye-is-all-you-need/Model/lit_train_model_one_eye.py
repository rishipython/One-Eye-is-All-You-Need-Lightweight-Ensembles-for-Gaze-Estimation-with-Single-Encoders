...
from lit_model_one_eye import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_cnn_one_eye/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-cnn-one-eye', help='Path store checkpoints')

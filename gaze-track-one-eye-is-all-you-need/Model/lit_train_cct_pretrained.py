...
from lit_cct_pretrained import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_cct_pretrained/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-cct-pretrained', help='Path store checkpoints')

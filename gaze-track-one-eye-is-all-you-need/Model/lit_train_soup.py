...
from lit_model_soup import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_cnn_SOUP/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-cnn-SOUP', help='Path store checkpoints')

...
from lit_alexnet import lit_gazetrack_model
...
parser.add_argument('--save_dir', default='../model/google_alexnet/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-alexnet', help='Path store checkpoints')
